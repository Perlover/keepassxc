...
void EditEntryWidget::setupMain()
{
    ...
    m_mainUi->togglePasswordButton->setIcon(resources()->onOffIcon("password-show"));
    m_mainUi->togglePasswordGeneratorButton->setIcon(resources()->icon("password-generator"));
